package com.github.phillipkruger.microprofileextentions.jwt.issuer;
 ...
 * TODO: Add Metrics
 */
@DeclareRoles({SecurityRoles.USER_ROLE,SecurityRoles.ADMIN_ROLE})
@Log
@RequestScoped
@Path("/token")
...
public class TokenService {
    ...
    @RolesAllowed({SecurityRoles.USER_ROLE,SecurityRoles.ADMIN_ROLE})
